			...
			<div className="bg-maroon-900 text-white">
						...
						<ul className="gap-6 items-center hidden sm:flex">
							{isLoggedIn ? (
								<div className="flex gap-3 items-center">
									<li className="mt-2 border-b-2 border-maroon-900 hover:border-maroon-400 cursor-pointer">
										<Notifications />
									</li>
									<li className="py-2 border-b-2 border-maroon-900 hover:border-maroon-400">
								...
								<>
									<Link
										href="/login"
										className="px-4 py-2 rounded-lg bg-maroon-900 hover:bg-maroon-700 cursor-pointer"
									>
										Login
									</Link>
									<Link
										className="px-4 py-2 rounded-lg hover:bg-maroon-700"
										href="/signup"
									>
										Signup
									</Link>
				...
				{showMobileNav && (
					<div className="bg-white text-black fixed top-0 bottom-0 left-0 z-[101] w-full sm:w-72 transition-transform duration-300 ease-in-out transform translate-x-0">
						<div className="flex justify-between items-center px-5 py-3 border-b border-maroon-900">
								...
								{isLoggedIn ? (
									...
									<>
										...
										<Link
											...
											onClick={toggleMobileNav}
										>
											<button className="bg-maroon-900 text-white px-5 py-2 rounded-lg">
												Signup
											</button>
										</Link>
									</>
